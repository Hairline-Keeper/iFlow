...
# Trun off function by "0"; Open the function by "1"
set cell_area_statics   0
set set_layout_region   1
set place_io            1
set place_macro         1
set place_macro_manual  0

#===========================================================
#   set tool related parameter
#===========================================================
set DIE_AREA            "0 0 500 500" 
set CORE_AREA           "5 5 495 495" 
...
if {$place_macro_manual == 1} {
foreach macro [find_macros] {
   $macro setOrigin 100 300
}
puts "--------------------------------------------------------------------------"
